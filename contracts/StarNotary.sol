...
contract StarNotary is ERC721 {
    ...
    string public name = Star Token; // name: Is a short name to your token
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        address starOwner = ownerOf(_tokenId); //1. Check if the sender is the ownerOf(_tokenId)
        _transferFrom(msg.sender, _to1, _tokenId);//2. Use the transferFrom(from, to, tokenId); function to transfer the Star
    }
